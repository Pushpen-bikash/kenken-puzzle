...
def counter():
    ...
    count = count + 1
    if count > 10000000:
        "Program has recursed through 10 million nodes. Would advise stopping the program and trying improvedBacktracking.py."
...
def backtrack0(board, coordinate, pieces, solution, rules):
    ...
    for num in findRemainingValues(solution, coordinate, list(range(1, len(board) + 1))):
        solution[i][j] = num
...
print ("Backtracking: Generated with {} recursive calls.".format(count))
